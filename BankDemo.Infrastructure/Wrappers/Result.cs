...
namespace BankDemo.Infrastructure.Wrappers
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        {
            return new ErrorResult<T> { Succeeded = false, Messages = new List<string> { message }, ErrorCode = 400 };
        }
        ...
        {
            return new ErrorResult<T> { Succeeded = false, Messages = messages, ErrorCode = 400 };
        }
        ...
        public static Result<T> Success(T data, List<string> messages, bool succeeded = true)
        {
            return new Result<T> { Succeeded = succeeded, Data = data, Messages = messages };
        }
        ...
        public static Task<Result<T>> SuccessAsync(T data, List<string> messages, bool success = true)
        {
            return Task.FromResult(Success(data, messages, success));
        }
    }
}
